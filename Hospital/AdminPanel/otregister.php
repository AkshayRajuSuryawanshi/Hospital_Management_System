                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">DIAGNIOSIS</label>
                                                     <select class="form-control">
                                                      <option >All</option>
                                                     </select>
                                                       </div><div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">SURGERY</label>
                                                           <select class="form-control">
                                                      <option >All</option>
                                                     </select>
                                                       </div><div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">SURGEON</label>
                                                           <select class="form-control">
                                                      <option >All</option>
                                                     </select>
                                                       </div>
