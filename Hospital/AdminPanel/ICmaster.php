                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link active fw-bold" aria-current="page" href="ICmaster.php">IC MASTER</a>
                    ...
                    <div class="col-xl-12">
                         <div class="row">
                            <div class="col-xl-12">
                                ...
                                <input type="text" name="" class="form-control" placeholder="Enter Mediclaim Company Name">
                            </div>
                         </div>
                     </div>
                 </div>
