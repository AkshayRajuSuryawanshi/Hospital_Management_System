                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="stockreport.php">STOCK REPORT</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">STORE NAME</label>
                                                           <select class="form-control">
                                                            <option>--ALL--</option>
                                                           </select>
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">MATERIAL TYPE</label>
                                                           <select class="form-control">
