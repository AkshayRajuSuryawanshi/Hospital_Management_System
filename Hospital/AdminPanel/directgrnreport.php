                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="directgrn.php">DIRECT GRN</a>
                                            ...
                                            style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                       ...
                                                       <button type="button" class="btn btn-outline-secondary"><i class="fa fa-print" id="elementID"></i> EXIT</button>
                                                       </div>
                                    </div> 
                                </div>
                              </div>
