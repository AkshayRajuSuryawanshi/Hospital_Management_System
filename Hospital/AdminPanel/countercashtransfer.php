                               ...
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    ...
                                    <a class="nav-link " aria-current="page" href="incometransaction.php">INCOME TRANSACTION</a>
                                      ...
                                      <a class="nav-link active fw-bold" href="countercashtransfer.php">COUNTER CASH TRANSFER</a>
                                        ...
                                        <div class="tab-content">
                                          <div class="tab-pane active p-3" id="home2" role="tabpanel">
                                                   ...
                                                   <div class="col-xl-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">YOUR COUNTER:</label>
                                                     <select class="form-control">
                                                        <option>-Counter 1-</option>
                                                     </select>
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">OTHER COUNTER:</label>
                                                     <select class="form-control">
                                                        <option>-Select Cash Counter-</option>
                                                     </select>
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">TRANSFER PERSON NAME:</label>
                                                       ...
                                                       <button type="button" data-bs-toggle="modal" data-bs-target="#exampleSubmit" class="btn btn-primary"><i class="fa fa-plus-circle"></i> TRANSFER</button>
											...
											<div class="tab-pane p-3" id="profile2" role="tabpanel">
											 <div class="card">
												  <div class="card-body">
													<div class="row">
                          <h4><b style="color:#990000;">Transferred Amount From : </b> Counter 1 </h4>  
                                         <div class="row mt-3">
                                        <div class="col-xl-12">
...
<div class="modal fade" id="exampleSubmit" tabindex="-1" aria-labelledby="exampleSubmit" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        PLEASE SELECT OTHER CASH COUNTER
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-bs-dismiss="modal">OK</button>
        <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
