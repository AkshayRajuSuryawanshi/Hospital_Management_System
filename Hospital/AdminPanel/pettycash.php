                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link active fw-bold" href="pettycash.php">Petty Cash Opening Balance</a>
                                    </nav>
                                </div>    
                                <div class="card-body">
                                    <div class="row">
          ...
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">PETTY CASH MASTER</h1>
                    ...
                    <div class="col-xl-12">
                         <div class="row">
                           <div class="col-xl-12">
                                ...
                                <input type="text" name="" class="form-control" placeholder="ENTER PETTY CASH OPENING BALANCE">
                            </div>
                         </div>
                      </div>
                 </div>
