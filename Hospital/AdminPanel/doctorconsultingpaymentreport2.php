                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="doctorconsultingpaymentreport2.php">DOCTOR CONSULTING PAYMENT REPORT 2</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">DATE TYPE</label>
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">REPORT FROM</label>
                                                       ...
                                                       <div class="col-xl-3 ">
                                                           <label class="control-label text-primary fw-bold">REPORT TYPE</label>
                                                 
                                                           <select class="form-control">
                                                            <option>--Doctor Vise--</option>
                                                           </select>
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">DOCTOR TYPE</label>
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">DOCTOR NAME</label>
                                                           <select class="form-control">
                                                            <option>Select Doctor</option>
                                                           </select>
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">PAYMENT STATUS</label>
                                                           <select class="form-control">
                                                            <option>All</option>
                                                           </select>
                                                       </div>
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                       <button type="button" data-bs-toggle="modal" data-bs-target="#exampleShow" class="btn btn-success"><i class="fa fa-check"></i> SHOW</button>
                                            ...
                                            style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                       ...
                                                       <button type="button" class="btn btn-outline-secondary"><i class="fa fa-times-circle" id="elementID"></i> EXIT</button>
                                                       <button type="button" class="btn btn-outline-secondary"><i class="fa fa-print" id="elementID"></i> PRINT</button>
                                                       <button type="button" class="btn btn-outline-secondary"><i class="fa fa-print" id="elementID"></i> EXCEL</button>
                                                       </div>
                                    </div> 
                                </div>
                              </div>
        ...
        <div class="modal fade" id="examplesupplier" tabindex="-1" aria-labelledby="examplesupplier" aria-hidden="true">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
             ...
             <!-- Add to Po-->
             <div class="modal fade" id="exampleShow" tabindex="-1" aria-labelledby="exampleShow" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <!-- <h1 class="modal-title fs-5" id="exampleShow">ADD NEW UOM IN MASTER</h1> -->
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <label class="control-label">PLEASE SELECT DATA TYPE</label>
                <!-- <input type="text" class="form-control" name="" placeholder="Enter Uom Name"> -->
              </div>
              <div class="modal-footer">
