                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="ipdsearchpatientrecord.php">IPD SEARCH PATIENT RECORD</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">MRN NO</label>
                                                           <input type="date" name="" class="form-control" value="" placeholder="Enter MRN no">
                                                       </div>
                                                       
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">IPD NO</label>
                                                           <input type="date" name="" class="form-control" value=""  placeholder="Enter IPD no">
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">FIRST NAME</label>
                                                           <input type="date" name="" class="form-control" value="" placeholder="Enter First Name">
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">MIDDLE NAME</label>
                                                           <input type="date" name="" class="form-control" value="" placeholder="Enter Middle Name">
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">LAST NAME</label>
                                                           <input type="date" name="" class="form-control" value="" placeholder="Enter Last Name">
                                                       </div>
                                                       <div class="col-xl-3" style="margin-top: 26px;">
