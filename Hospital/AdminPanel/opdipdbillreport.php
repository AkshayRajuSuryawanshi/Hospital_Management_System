                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">OPD/IPD</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">PAY DETAILS</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">CONSULTING DOCTOR</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">SHOW SERVICES</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">IPD SERVICES</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3" style="margin-top: 42px;">
                                                       <button type="button" class="btn btn-success"><i class="fa fa-check"></i> SHOW</button>
