                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link  active fw-bold" href="referencedoctor.php">REFERENCE DOCTOR MASTER</a>
          ...
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">REFERENCE DOCTOR MASTER</h1>
                    ...
                    <div class="col-xl-12">
                         ...
                         <div class="row mt-3">
                            ...
                            <div class="col-xl-4">
                                ...
                                <input type="date" name="" class="form-control" placeholder="Email">
                            </div>
                         </div>
                         <div class="row mt-3">
                            <div class="col-xl-4">
                          ...
                          <div class="col-xl-4">
                                ...
                                <textarea class="form-control" placeholder="Address" style="width: 100%;height: 15px !important;"></textarea>
                          </div>  
                          <div class="col-xl-4">
                               <label class="control-label fw-bold">VILLAGE/TOWN</label>
                               <select class="form-control">
