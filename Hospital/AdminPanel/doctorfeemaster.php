                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link active fw-bold" href="doctorfeemaster.php">DOCTOR FEE MASTER</a>
                                     </nav>
                                </div>    
                                <div class="card-body">
                                    <div class="row">
          ...
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">DOCTOR FEE MASTER</h1>
                         ...
                         <div class="row">
                            <div class="col-xl-4">
                                ...
                                <select class="form-control">
                                  ...
                                  <option>Dr. Kavita Gaikar</option>
                                </select>
                            </div>
                            <div class="col-xl-4">
                                <label class="control-label">FEE Type Name</label>
                                <select class="form-control">
                            ...
                            <div class="col-xl-4">
                              ...
                              <input type="text" placeholder="Enter Charges" name="" class="form-control">
                            </div>
                         </div>
                     </div>
                 </div>
