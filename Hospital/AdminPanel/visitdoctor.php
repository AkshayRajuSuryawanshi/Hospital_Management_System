                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link  active fw-bold" href="visitdoctor.php">VISIT DR. MASTER</a>
          ...
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">VISIT DOCTOR MASTER</h1>
