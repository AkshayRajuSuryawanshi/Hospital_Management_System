                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="billnowisereport.php">BILL NO WISE REPORT</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">BILL FROM</label>
                                                           <input type="date" name="" class="form-control" value="" placeholder="Enter Date">
                                                       </div>
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">BILL NO FROM</label>
                                                           <input type="date" name="" class="form-control" value="" placeholder="Enter Bill no">
                                                       </div>
