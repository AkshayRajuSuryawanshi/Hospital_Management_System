                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       ...
                                                       <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-plus-circle"></i> SAVE INCOME</button>
      ...
      <div class="modal-footer">
        ...
        <div class="modal fade" id="examplesupplier" tabindex="-1" aria-labelledby="examplesupplier" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="examplesupplier">ADD NEW INCOME IN MASTER</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <!-- <label class="control-label">COMPANY NAME</label> -->
                <input type="text" class="form-control" name="" placeholder="Enter Income Name">
              </div>
              <div class="modal-body">
              <select class="form-control">
