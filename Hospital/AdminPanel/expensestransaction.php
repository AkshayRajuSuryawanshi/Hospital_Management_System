                               ...
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link active fw-bold" href="expensestransaction.php">EXPENSES TRANSACTION</a>
                                         ...
                                         <div class="row mt-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                           ...
                                                           <select class="form-control">
                                                            <option>--Select Expenses Name--</option>
                                                           </select>
                                                       </div>
                                                       ...
                                                       <button type="button" data-bs-toggle="modal" data-bs-target="#examplesaveexpenses" class="btn btn-primary"><i class="fa fa-plus-circle"></i> SAVE EXPENSES</button>
                                                       <button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button>
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">FROM</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                       ...
                                                       <button type="button" class="btn btn-primary">TODAT TRANSACTION</button>
                                                       </div>
      ...
      <div class="modal-footer">
        ...
        <div class="modal fade" id="examplesupplier" tabindex="-1" aria-labelledby="examplesupplier" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="examplesupplier">ADD NEW EXPENSES IN MAASTER</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <!-- <label class="control-label">COMPANY NAME</label> -->
                <input type="text" class="form-control" name="" placeholder="Enter Expanses Name">
              </div>
              <div class="modal-body">
                <!-- <label class="control-label">COMPANY NAME</label> -->
                <select class="form-control">
                  <option >-Select Expanses Group-</option>
                </select>
              </div>
              <div class="modal-footer">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
             ...
             <!-- Add to Po-->
             <div class="modal fade" id="examplesaveexpenses" tabindex="-1" aria-labelledby="examplesaveexpenses" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <!-- <h1 class="modal-title fs-5" id="examplesaveexpenses">ADD NEW UOM IN MASTER</h1> -->
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <label class="control-label">PLEASE SELECT EXPENSES NAME</label>
                <!-- <input type="text" class="form-control" name="" placeholder="Enter Uom Name"> -->
              </div>
              <div class="modal-footer">
