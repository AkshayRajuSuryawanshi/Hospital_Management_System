                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">PERSON RETURN NAME</label>
                                                           <input type="text" name="" class="form-control" placeholder="Remark:Person Name">
                                                       </div>
                                                       <div class="col-xl-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                       <button type="button" style="margin-top: 26px;" class="btn btn-primary"><i class="fa fa-search"></i> SEARCH RETURNED DETAILS</button>
                                                       </div>  
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">RETURN QTY</label>
                                                       ...
                                                       <div class="col-xl-2">
                                                       <button type="button" data-bs-toggle="modal" data-bs-target="#exampleadd" style="margin-top: 42px;" class="btn btn-primary">ADD TO RETURN</button>
                                                        <!-- <button type="button" style="margin-top: 26px;" class="btn btn-primary"><i class="fa fa-search"></i> SEARCH PAST ISSUED DETAILS</button> -->
                                                       </div> 
                                                        <div class="col-xl-3">
                                                       <!-- <button type="button" style="margin-top: 42px;" class="btn btn-primary">ADD TO RETURN</button> -->
                                                        <button type="button" style="margin-top: 42px;" class="btn btn-primary"><i class="fa fa-search"></i> SEARCH PAST ISSUED DETAILS</button>
                                                       </div>
