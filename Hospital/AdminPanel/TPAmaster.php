                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link active fw-bold" href="TPAmaster.php">TPA MASTER</a>
                                      <a class="nav-link" href="DefineTPA.php">DEFINE TPA</a>
                                     </nav>
                                </div>    
                                <div class="card-body">
                                    <div class="row">
          ...
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">TPA MASTER</h1>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-xl-12">
                         <div class="row">
                            <div class="col-xl-12">
                                <label class="control-label">TPA NAME</label>
                                <input type="text" name="" class="form-control" placeholder="Enter TPA NAME">
                            </div>
                         </div>
                     </div>
                 </div>
