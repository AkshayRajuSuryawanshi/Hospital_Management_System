                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="doctorconsultingpaymentreport.php">DOCTOR CONSULTING PAYMENT REPORT</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                         <div class="row mt-3">
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">PATIENT TYPE</label>
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">DATA TYPE</label>
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">STATEMENT MONTH</label>
                                                           <select class="form-control">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleShow"></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        PLEASE SELECT STATEMENT MONTH
      </div>
