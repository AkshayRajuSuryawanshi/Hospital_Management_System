                               ...
                               <div class="col-xl-12">
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="accountmaster.php">Income Group</a>
          ...
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">ADD INPUT GROUP</h1>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-xl-12">
                         <div class="row">
                            <div class="col-xl-12">
                                <label class="control-label text-primary fw-bold">INPUT GROUP</label>
                                <input type="text" name="" class="form-control" placeholder="ENTER INPUT GROUP">
                            </div>
