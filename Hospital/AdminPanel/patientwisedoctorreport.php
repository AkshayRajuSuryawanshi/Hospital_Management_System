                        ...
                        <div class="row">
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      <a class="nav-link active fw-bold" aria-current="page" href="patientwisedoctorpayment.php">PATIENT WISE DOCTOR PAYMENT</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#profile2" role="tab">
                                                    <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                                    <span class="d-none d-sm-block">MAKE PAYMENT</span>
                                                </a>
                                            </li>
                                          ...
                                          <div class="tab-pane active p-3" id="home2" role="tabpanel">
										                         <!-- <div class="card"> -->
											                    	<div class="card-body">
												                        <div class="row">
                                                   <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">SELECT DISCHARGE START DATE</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">SELECT DISCHARGE END DATE</label>
                                                           <input type="date" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3">
                                                       ...
                                                       <div class="col-xl-3">
                                                       <button type="button" style="margin-top: 26px;" class="btn btn-success"><i class="fa fa-check"></i> SHOW PATIENT</button>
                                                       </div>
                                                       <div class="row mt-3">
                                        <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">PATIENT NAME</label>
                                                           <input type="text" name="" class="form-control" value="">
                                                       </div> 
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">DISCHARGE DATE</label>
                                                           <input type="text" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3">
                                                           <label class="control-label text-primary fw-bold">REFERANCE DOCTOR</label>
                                                           <input type="text" name="" class="form-control" value="">
                                                       </div>
                                                       <div class="col-xl-3">
                                                       <button type="button" style="margin-top: 26px;" class="btn btn-success">VIEW BILL</button>
                                                       </div>
                                                    ...
                                                    <select class="form-control">
                                                      <option>Select</option>
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">SELECT</label>
                                                           <select class="form-control">
                                                      <option>Select</option>
                                                    </select>
                                                       </div>
                                                       <div class="col-xl-3 mt-3">
                                                           <label class="control-label text-primary fw-bold">CO-PAYMENT AMOUNT</label>
                                                       ...
                                                       <div class="col-xl-3 mt-3">
                                                       <button type="button" class="btn btn-primary">ADD TO SUBMIT</button>
                                                       </div>
                                                       <div class="row mt-3">
                                        <div class="col-xl-12">
                                            <table id="datatable" class="table dt-responsive nowrap table-striped" 
											...
											<div class="tab-pane p-3" id="profile2" role="tabpanel">
											 <!-- <div class="card"> -->
												  <div class="card-body">
													<div class="row">
                          <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                                                       <button type="button" class="btn btn-primary">GET PAYMENT LIST</button>
                                                       <!-- <button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button> -->
                                                       </div>
