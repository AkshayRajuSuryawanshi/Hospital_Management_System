                                ...
                                <div class="card">
                                 <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link active fw-bold" href="designation.php">DESIGNATION</a>
          ...
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">DESIGNATION MASTER</h1>
                    ...
                    <div class="col-xl-12">
                         <div class="row">
                            <div class="col-xl-12">
                                ...
                                <input type="text" name="" class="form-control" placeholder="Enter Designation Name">
                            </div>
